...
```ts
import { useCreateUser, useGetNotes, useUpdateNote, useListPublicCategories } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser();

const { data, isPending, isSuccess, isError, error } = useGetNotes();
...
```js
import { createUser, getNotes, updateNote, listPublicCategories } from '@dataconnect/generated';
